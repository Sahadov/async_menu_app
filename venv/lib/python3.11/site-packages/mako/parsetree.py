...
class ControlLine(Node):
    ...
    def __repr__(self):
        return 'ControlLine({!r}, {!r}, {!r}, {!r})'.format(
            self.keyword,
            self.text,
            self.isend,
...
class Text(Node):
    ...
    def __repr__(self):
        return f'Text({self.content!r}, {(self.lineno, self.pos)!r})'
...
class Comment(Node):
    ...
    def __repr__(self):
        return f'Comment({self.text!r}, {(self.lineno, self.pos)!r})'
...
class Expression(Node):
    ...
    def __repr__(self):
        return 'Expression({!r}, {!r}, {!r})'.format(
            self.text,
