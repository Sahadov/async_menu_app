...
class URL:
    ...
    def remove_query_params(
        self, keys: str | typing.Sequence[str]
    ) -> 'URL':
    ...
    def __init__(
        ...
        **kwargs: typing.Any,
        ...
        if not value:
            ...
            value = typing.cast(
                list[tuple[typing.Any, typing.Any]], value
            )
            _items = list(value)
...
class MultiDict(ImmutableMultiDict[typing.Any, typing.Any]):
    ...
    def poplist(self, key: typing.Any) -> list:
    ...
    def setlist(self, key: typing.Any, values: list) -> None:
        if not values:
            self.pop(key, None)
        else:
