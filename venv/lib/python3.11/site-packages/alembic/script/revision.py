...
class RevisionMap:
    ...
    def get_revisions(
        self, id_: str | Collection[str | None] | None
        ...
        if match:
            ...
            if rel_int >= 0:
                ...
                rev = self._walk(
                    ...
                    else self.get_revision(f'{branch_label}@{symbol}'),
                    steps=rel_int,
                    no_overwalk=assert_relative_length,
                )
                if rev is None:
    ...
    def _parse_upgrade_target(
        ...
        current_revisions_tup: str | Collection[str | None] | None
...
class Revision:
    ...
    def __repr__(self) -> str:
        ...
        if self.dependencies:
            args.append(f'dependencies={self.dependencies!r}')
        if self.branch_labels:
            args.append(f'branch_labels={self.branch_labels!r}')
...
@overload
def tuple_rev_as_scalar(
    rev: Sequence[str | None] | None,
) -> str | None | Sequence[str | None] | None:
    ...
