...
class CreateCheckConstraintOp(AddConstraintOp):
    ...
    def create_check_constraint(
        ...
        constraint_name: str | None,
        table_name: str,
        condition: str | BinaryExpression | TextClause,
        *,
        schema: str | None = None,
        **kw: Any,
    ) -> None:
...
class AlterColumnOp(AlterTableOp):
    ...
    def alter_column(
        ...
        *,
        ...
        existing_type: TypeEngine | type[TypeEngine] | None = None,
        existing_server_default: None | (
            str | bool | Identity | Computed
        ) = False,
        existing_nullable: bool | None = None,
        existing_comment: str | None = None,
        schema: str | None = None,
...
class ExecuteSQLOp(MigrateOperation):
    ...
    def __init__(
        self,
        sqltext: Update | str | Insert | TextClause,
        *,
