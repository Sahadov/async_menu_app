...
class ORMDescriptor(Generic[_T], TypingOnly):
    ...
    if typing.TYPE_CHECKING:
        ...
        ) -> ORMDescriptor[_T] | SQLCoreOperations[_T] | _T:
            ...
...
class Mapped(
    ...
    if typing.TYPE_CHECKING:
        ...
        def __set__(
            self, instance: Any, value: SQLCoreOperations[_T] | _T
        ) -> None:
            ...
...
class DynamicMapped(_MappedAnnotationBase[_T]):
    ...
    if TYPE_CHECKING:
        ...
        def __get__(
            self, instance: object | None, owner: Any
        ) -> InstrumentedAttribute[_T] | AppenderQuery[_T]:
            ...
...
class WriteOnlyMapped(_MappedAnnotationBase[_T]):
    ...
    if TYPE_CHECKING:
        ...
        def __get__(
            self, instance: object | None, owner: Any
        ) -> InstrumentedAttribute[_T] | WriteOnlyCollection[_T]:
            ...
